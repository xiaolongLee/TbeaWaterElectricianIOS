...
- (void)viewDidLoad {
    ...
    [_cameraBtn setBackgroundImage:LOADIMAGE(@"扫码", @"png") forState:UIControlStateNormal];
    [_cameraBtn setBackgroundImage:LOADIMAGE(@"扫码", @"png") forState:UIControlStateHighlighted];
