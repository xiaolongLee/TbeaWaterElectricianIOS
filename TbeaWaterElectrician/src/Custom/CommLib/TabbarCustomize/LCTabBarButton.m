...
-(CGRect)titleRectForContentRect:(CGRect)contentRect{
    return CGRectMake(0, contentRect.size.height*kImageRatio-3, contentRect.size.width, contentRect.size.height-contentRect.size.height*kImageRatio);
}

//#pragma mark 返回按钮内部UIImage的边框
//-(CGRect) imageRectForContentRect:(CGRect)contentRect{
//	DLog(@"contentrect=== %f,%f",contentRect.size.width,contentRect.size.height);
