...
- (void)addSubView{
    ...
    UIView * bottomView =[[UIView alloc]initWithFrame:CGRectMake(0, kScreenHeight - 64-45, kScreenWidth, 45)];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
	...
	if(cell.selectedStatus==YES)
	{
		...
		imageview.image = LOADIMAGE(@"Overlay", @"png");
		imageview.tag = 22222;
		[cell.contentView addSubview:imageview];
	}
	else
	{
		[[cell.contentView viewWithTag:22222] removeFromSuperview];
	}
