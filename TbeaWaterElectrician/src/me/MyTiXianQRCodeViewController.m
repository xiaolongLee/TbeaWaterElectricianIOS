...
//	UIImageView *imageviewline2 = [[UIImageView alloc] initWithFrame:CGRectMake(imageviewline1.origin.x, imageviewline1.frame.origin.y+imageviewline1.frame.size.height+80, imageviewxuxian1.frame.size.width, 0.5)];
//	imageviewline2.backgroundColor = Colorgray;
//	[self.view addSubview:imageviewline2];
	
//	NSString *strtixian = [NSString stringWithFormat:@"提现单位:%@",[dicdistributorinfo objectForKey:@"name"]];
//	NSString *straddr = [NSString stringWithFormat:@"地址:%@",[dicdistributorinfo objectForKey:@"addr"]];
//	NSString *strtel = [NSString stringWithFormat:@"电话:%@",[dicdistributorinfo objectForKey:@"mobilenumber"]];
//	
//	UILabel *labelins = [[UILabel alloc] initWithFrame:CGRectMake(imageviewbg.frame.origin.x+20, imageviewline1.frame.origin.y+5, imageviewbg.frame.size.width-40, 70)];
//	labelins.textColor = ColorBlackGray;
//	labelins.font = FONTN(14.0f);
//	labelins.numberOfLines = 4;
//	labelins.text = [NSString stringWithFormat:@"%@\n%@\n%@",strtixian,straddr,strtel];
...
-(void)getmytixianmessage
{
	...
	[RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:@"TBEAENG005001010000" ReqUrl:URLHeader ShowView:self.view alwaysdo:^
	 {
