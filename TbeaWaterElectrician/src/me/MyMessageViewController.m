...
//	NSString *str = @"http://www.u-shang.net/enginterface/index.php/Apph5/messagelist?messagecategoryid=";
    NSString *str = [NSString stringWithFormat:@"%@%@",[app.GBURLPreFix length]>0?app.GBURLPreFix:URLHeader,HttpMessageDetail];
...
-(void)getmymessage:(NSString *)page Pagesize:(NSString *)pagesize
{
	...
	[RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:@"TBEAENG005001013000" ReqUrl:URLHeader ShowView:self.view alwaysdo:^
	 {
