//
//  ModifyBindingDoneViewController.m
...
#import "ModifyBindingDoneViewController.h"

@interface ModifyBindingDoneViewController ()

@end

@implementation ModifyBindingDoneViewController
...
//	[self.view addSubview:labellogin];
	...
	btlogin.frame = CGRectMake(40, labeldone.frame.origin.y+labeldone.frame.size.height+50, SCREEN_WIDTH-80, 35);
