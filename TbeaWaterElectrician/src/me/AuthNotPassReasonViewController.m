...
-(void)initview
{
    ...
    tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-StatusBarAndNavigationHeight-IPhone_SafeBottomMargin)];
    ...
    buttonnext.frame = CGRectMake(20, SCREEN_HEIGHT-70-StatusBarAndNavigationHeight-IPhone_SafeBottomMargin, SCREEN_WIDTH-40, 40);
...
-(void)getauthbusinessreason
{
    ...
    [RequestInterface doGetJsonWithParametersNoAn:params App:app RequestCode:@"TBEAENG005001002005" ReqUrl:URLHeader ShowView:self.view alwaysdo:^
     {
